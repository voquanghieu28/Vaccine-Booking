...
export default function PhysicianView(props) {
  ...
  return (
    <div>
      <Welcome
        post={{
          title: "Book vaccine appointment today!",
          description:
            "You could book vaccination appointment with just a simple click. There are alot of availibilites and locations you could choose",
          image:
